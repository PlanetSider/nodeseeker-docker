...
export const baseConfigUpdateSchema = z.object({
    ...
    serverchan_enabled: z.union([z.number().int().min(0).max(1), z.boolean().transform(val => val ? 1 : 0)]).optional(),
    serverchan_uid: z.string().optional(),
    serverchan_sendkey: z.string().optional(),
    meow_enabled: z.union([z.number().int().min(0).max(1), z.boolean().transform(val => val ? 1 : 0)]).optional(),
    meow_endpoint: z.string().optional(),
    meow_nickname: z.string().optional(),
    meow_token: z.string().optional(),
    telegram_last_test_status: z.string().optional(),
    telegram_last_test_at: z.string().optional(),
    telegram_last_send_at: z.string().optional(),
    telegram_last_error: z.string().optional(),
    serverchan_last_test_status: z.string().optional(),
    serverchan_last_test_at: z.string().optional(),
    serverchan_last_send_at: z.string().optional(),
    serverchan_last_error: z.string().optional(),
    meow_last_test_status: z.string().optional(),
    meow_last_test_at: z.string().optional(),
    meow_last_send_at: z.string().optional(),
    meow_last_error: z.string().optional(),
    feishu_enabled: z.union([z.number().int().min(0).max(1), z.boolean().transform(val => val ? 1 : 0)]).optional(),
    feishu_app_id: z.string().optional(),
    feishu_app_secret: z.string().optional(),
    feishu_verification_token: z.string().optional(),
    feishu_chat_id: z.string().optional(),
    feishu_bound_user_name: z.string().optional(),
    feishu_bound_user_id: z.string().optional(),
    feishu_last_test_status: z.string().optional(),
    feishu_last_test_at: z.string().optional(),
    feishu_last_send_at: z.string().optional(),
    feishu_last_error: z.string().optional(),
